        ...
        <main className="min-h-screen bg-black text-white selection:bg-brand-orange/30 pt-24">
            ...
            <section className="relative px-4 md:px-8 py-20 overflow-hidden">
                ...
                <div className="container mx-auto max-w-5xl text-center relative z-10">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-brand-orange mb-8 backdrop-blur-md"
                    >
                    ...
                    >
                        ...
                        <span className="text-white">Enterprise RAG</span>
                    </motion.h1>
            ...
            <section className="py-32 px-4 md:px-8 border-t border-white/10 relative overflow-hidden">
                ...
                <div className="container mx-auto max-w-4xl text-center relative z-10">
                    <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to ingest?</h2>
