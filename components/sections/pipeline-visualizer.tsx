...
const pipelines = [
    {
        ...
        steps: [
            ...
            { id: "p1-2", title: "Process", tool: "Unstructured.io", icon: FileJson },
    ...
    },
    {
        ...
        steps: [
            ...
            { id: "p2-2", title: "Transcribe", tool: "Whisper", icon: Mic },
    ...
    },
    {
        ...
        steps: [
            ...
            { id: "p3-2", title: "Scrape", tool: "Firecrawl", icon: Search },
                    ...
                    {pipelines.map((pipeline, pIndex) => (
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute top-1/2 left-0 w-full -translate-y-1/2 h-1 bg-white/5 rounded-full overflow-hidden">
                                    <motion.div
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 relative z-10">
                                    {pipeline.steps.map((step, sIndex) => (
                                        <div key={step.id} className="group relative">
                                            <div className="relative p-4 rounded-xl bg-black/80 border border-white/10 backdrop-blur-sm hover:border-white/30 transition-colors">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-sm font-bold text-gray-200 group-hover:text-white">{step.tool}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
