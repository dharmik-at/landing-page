...
export function Solutions() {
    return (
        <section className="py-24 px-4 md:px-8 bg-black relative overflow-hidden" id="solutions">
            {/* Background Effects */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[350px]">
                    ...
                    <Link href="/solutions/meeting-intelligence" className="col-span-1 md:col-span-2 lg:col-span-2 row-span-2 block group">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="w-full h-full relative overflow-hidden rounded-3xl border border-white/10 bg-[#0A0A0A]"
                        >
                            ...
                            <div className="absolute top-8 left-8 z-20 pointer-events-none">
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 className="text-2xl font-bold text-white">Meeting Intelligence</h3>
                                </div>
                        ...
                        >
                            ...
                            <div className="absolute top-8 left-8 z-20 pointer-events-none">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <h3 className="text-xl font-bold text-white">Web Intelligence</h3>
                                </div>
                        ...
                        >
                            ...
                            <div className="absolute top-6 left-6 z-20 pointer-events-none">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h3 className="text-lg font-bold text-white">Visual Knowledge</h3>
                                </div>
                        ...
                        >
                            ...
                            <div className="absolute top-6 left-6 z-20 pointer-events-none">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <h3 className="text-lg font-bold text-white">Unified Knowledge</h3>
                                </div>
                                <p className="text-sm text-gray-400">
